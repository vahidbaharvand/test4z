...
TEST4Z_BATCHAPP_CUSTIN="TEST4Z.BATCHAPP.CUSTIN";
...
DSNValidation "$TEST4Z_BATCHAPP_CUSTIN"
...
upload "$TEST4Z_BATCHAPP_CUSTIN" BROADCOM.TEST4Z.BATCHAPP.CUSTIN DS N
